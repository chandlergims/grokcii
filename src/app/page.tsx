...
export default function Home() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 relative">
      {/* Grok API Status - Positioned in top right */}
      <div className="absolute top-3 right-3 z-50 flex items-center opacity-80 hover:opacity-100 transition-opacity">
        <span className="text-xs font-medium whitespace-nowrap tracking-wide" style={{ color: '#91c9a6', fontFamily: 'var(--font-geist-mono)' }}>
          Grok API
        </span>
        <span className="inline-block w-2 h-2 rounded-full ml-1.5" style={{ backgroundColor: '#91c9a6', boxShadow: '0 0 4px rgba(145, 201, 166, 0.7)' }}></span>
      </div>
      ...
      <div className="relative">
        <div className="absolute top-0 left-0 w-64 p-3 rounded-lg border border-[#91c9a6] shadow-md z-10" 
          ...
          <p className="text-xs mb-1" style={{ color: '#91c9a6', lineHeight: '1.2' }}>
            Every wallet gets a unique ASCII character generated by Grok AI with a name and backstory.
          </p>
          <p className="text-xs" style={{ color: '#91c9a6', lineHeight: '1.2' }}>
      ...
      <div className="mt-4 mb-6">
        ...
        {isGrokLoading ? (
          <div className="max-w-xs mx-auto flex justify-center items-center h-40 rounded-md border border-[#91c9a6] shadow" style={{ backgroundColor: '#000000', color: '#91c9a6' }}>
